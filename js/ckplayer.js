...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		...
		以下是播放器自带的二个插件
		*/
        control_rel: 'related.swf,xinplayer/related.xml,0',
        /*
		视频结束显示精彩视频的插件
		...
		*/
		...
		/*
			跳过广告和播放结束时调用的js函数
		*/
        myweb: escape('680d97ebf8f560996c15cbf3b2bc9078,滨州传媒,http://www.bzcm.net,v6.5'),
        /*
		------------------------------------------------------------------------------------------------------------------
		...
		*/
        cpt_share: 'http://www.bzcm.net/xinplayer/share.xml',
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
