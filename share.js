...
(function($, window, document, undefined) {
    ...
    function init(target, options) {
        ...
        $(document).on("mouseover",".msb_main",function(){
    ...
    $.fn.socialShare.defaults = {
        url:$('#socialShare').siblings('a').attr('href'),
        title:$('#socialShare').siblings('a').find('h3').html(),
        content:$('#socialShare').siblings('a').find('p').html(),
        pic: ''
    }
	//插件方法
